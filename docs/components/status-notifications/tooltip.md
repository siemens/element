...
**Tooltips** provide concise supplementary information when users hover over or focus on a UI element.
...
- Never add tooltips in disabled elements.
...
- Use a 500 ms show delay and dismiss on pointer leave or focus loss.
