...
If the badge contains only a label, it is displayed as a simple dot to indicate that something requires attention.
Badges can also be fully hidden in the collapsed state if needed.
