...
Most scenarios allow you to use the HTML semantic (e.g. `h1`, `p`) directly, all the required styles are set by default.
...
| Style              | Alternative     |
|--------------------|-----------------|
| `.si-display-xl`   | `.si-display-1` |
| `.si-display-lg`   | `.si-display-2` |
| `.si-display-bold` | `.si-display-3` |
| `.si-display`      | `.si-display-4` |
...
| Sematic element| Alternative style              | Description                                                                        |
|----------------|--------------------------------|------------------------------------------------------------------------------------|
| `<mark>`       | `.mark`                        | Represents text which is marked or highlighted for reference or notation purposes. |
| `<s>`          | `.text-decoration-line-through`| Represents element that are no longer relevant or no longer accurate.              |
...
| `<em>`         | `.fst-italic`                  | Represents line rendered as italicized text. |
