...
--8<-- "si-sys.md:si-sys-color-data-categorical"
...
--8<-- "si-sys.md:si-sys-color-data-rating"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-avocado"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-green"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-turquoise"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-interactive-coral"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-blue"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-royal-blue"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-purple"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-orchid"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-plum"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-red"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-orange"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-yellow"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-sand"
...
--8<-- "si-sys.md:si-sys-color-data-sequential-deep-blue"
