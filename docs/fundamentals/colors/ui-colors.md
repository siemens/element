...
| <si-docs-color style="background: #edd6f2;"></si-docs-color>   | <si-docs-color style="background: #52245c;"></si-docs-color>   | `$element-base-critical`      | Critical component background for e.g. status             | `$siemens-data-orchid-100`       | `$siemens-data-orchid-700`   |
