 ...
 */
import type { MapPoint } from '@siemens/maps-ng';
...
export const mockGroupedPoints: MapPoint[] = [
  ...mockGeneratedPoints,
  {
    ...
    name: 'Point 1',
    description: 'Group 1',
    click: (extraProperties: unknown) => console.log(JSON.stringify(extraProperties)),
    extraProperties: {},
    group: 1
  },
  {
  ...
  },
  {
    ...
    click: (extraProperties: unknown) => alert(JSON.stringify(extraProperties)),
    extraProperties: {},
    group: 1
  },
  {
