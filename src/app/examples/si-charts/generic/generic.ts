...
export class SampleComponent {
  ...
  private createChartColors(): EChartOption {
    ...
    const colors = [
      this.getProp(style, '--si-sys-color-data-sequential-plum-1', '#e5659b'),
      this.getProp(style, '--si-sys-color-data-sequential-plum-2', '#c04774'),
      this.getProp(style, '--si-sys-color-data-sequential-plum-3', '#9f1853'),
      this.getProp(style, '--si-sys-color-data-sequential-plum-4', '#4f153d')
    ];
    return {
      color: colors
    };
