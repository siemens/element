...
export class SampleComponent {
  ...
  colDefs: ColDef<CarDefs>[] = [
    ...
    { field: 'dateOfManufacture', headerName: 'Date of Manufacture', minWidth: 150 }
  ];
  ...
  onGridReady(params: GridReadyEvent<CarDefs>): void {
    // Generate 500 rows of data
    this.allData = generateCarRows(500);
