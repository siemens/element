...
import {
  ...
  SiNavbarVerticalNextModule
} from '@siemens/element-ng/navbar-vertical-next';
import { LOG_EVENT } from '@siemens/live-preview';

@Component({
  selector: 'app-sample',
  imports: [SiNavbarModule, SiNavbarVerticalNextModule],
  templateUrl: './si-navbar-vertical-next-legacy.html',
...
export class SampleComponent {
  ...
  onItemsChange(anyItems: (MenuItem | NavbarVerticalNextItem)[]): void {
