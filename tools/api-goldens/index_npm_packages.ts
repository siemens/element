/* eslint-disable headers/header-format, @typescript-eslint/explicit-function-return-type, tsdoc/syntax, @typescript-eslint/naming-convention, prefer-arrow/prefer-arrow-functions,no-console */
/**
 * @license
...
export async function main(
  ...
  if (outdatedGoldens.length) {
    ...
    console.info();
    console.info(chalk.yellow(`The goldens can be updated by running: npm run api-goldens:accept`));
  }
