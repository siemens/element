...
test('si-ai-message/si-ai-message', ({ si }) => si.static());
test('si-user-message/si-user-message', ({ si }) => si.static());
test('si-tool-message/si-tool-message', ({ si }) => si.static());
test('si-chat-input/si-chat-input', ({ si }) => si.static());
test('si-chat-container/si-chat-container', ({ si }) => si.static());
test('si-chat-message/si-chat-message', ({ si }) => si.static());
test('si-attachment-list/si-attachment-list', ({ si }) => si.static());
test('si-action-bar/si-action-bar', ({ si }) => si.static());
test('si-markdown-content/si-markdown-content', ({ si }) => si.static());
