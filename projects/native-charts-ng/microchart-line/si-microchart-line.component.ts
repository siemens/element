...
export interface MicrochartLineSeries {
   ...
   *
   * @example "si-sys-color-data-categorical-10"
   */
  colorToken: string;
}
...
export class SiMicrochartLineComponent {
   ...
   * @example
   * ```ts
   * Series: MicrochartLineSeries = { values: [2, 3, 6, 5, 4, 7, 8], colorToken: 'si-sys-color-data-categorical-10' };
   * ```
   */
   ...
   * Use a data-color. See: {@link https://element.siemens.io/fundamentals/colors/data-visualization-colors/#tokens}
   *
   * @example "si-sys-color-data-categorical-2"
   */
