...
import { addTestFiles, createTestApp, readLines } from '../utils/testing';
...
describe('action modal migration', () => {
  ...
  test('should migrate `showAlertDialog` method and its type usage', async () => {
    const original = [
  ...
  test('should migrate `showConfirmationDialog` method and its type usage', async () => {
    const original = [
      `import { Component, inject } from '@angular/core';`,
  ...
  test('should migrate `showEditDiscardDialog` method and its type usage', async () => {
    const original = [
      `import { Component, inject } from '@angular/core';`,
  ...
  test('should migrate `showDeleteConfirmationDialog` method and its type usage', async () => {
    const original = [
      `import { Component, inject } from '@angular/core';`,
  ...
  test('should migrate multiple instances of action modal methods', async () => {
    const original = [
      `import { Component, inject } from '@angular/core';`,
  ...
  test('should migrate action modal methods if its imported from @siemens/element-ng/action-modal', async () => {
    const original = [
      `import { Component, inject } from '@angular/core';`,
      `import { AlertDialogResult, SiActionDialogService } from '@siemens/element-ng/action-modal';`,
      `@Component({ selector: 'app-test-action-modal' })`,
  ...
  test('should migrate action modal methods even if we do not have dialog method subscribed', async () => {
    const original = [
      `import { Component, inject } from '@angular/core';`,
      `import { AlertDialogResult, SiActionDialogService } from '@siemens/element-ng/action-modal';`,
      `@Component({ selector: 'app-test-action-modal' })`,
