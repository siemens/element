...
describe('SiMapComponent', () => {
  ...
  beforeAll(() => {
    ...
    document.documentElement.style.setProperty('--si-sys-color-background-information', '#0070F2');
    document.documentElement.style.setProperty('--si-sys-color-background-success', '#00A04B');
    document.documentElement.style.setProperty('--si-sys-color-background-warning', '#FF7F00');
    document.documentElement.style.setProperty('--si-sys-color-background-danger', '#D8371C');
    document.documentElement.style.setProperty('--si-sys-color-background-caution', '#FFD322');
    document.documentElement.style.setProperty('--si-sys-color-background-critical', '#B71E24');
    document.documentElement.style.setProperty('--si-sys-color-background-accent', '#0070F2');
    document.documentElement.style.setProperty('--si-sys-color-border-3', '#004987');
    document.documentElement.style.setProperty('--si-sys-color-background-1', '#FFFFFF');
    document.documentElement.style.setProperty('--si-sys-color-text-primary', '#1F2937');
    document.documentElement.style.setProperty('--si-sys-color-data-sequential-red-2', '#D8371C');
    document.documentElement.style.setProperty(
      '--si-sys-color-data-sequential-orange-4',
      '#FF7F00'
    );
    document.documentElement.style.setProperty('--si-sys-color-data-sequential-green-2', '#00A04B');
    document.documentElement.style.setProperty('--si-sys-color-data-categorical-1', '#007C7C');
    document.documentElement.style.setProperty('--si-sys-color-data-categorical-17', '#004A87');
  });
