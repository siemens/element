...
// Colors
const siemensDeepBlue900 = 'rgba(32, 33, 50, 1)';
const siemensGreen700 = (opacity: number): string => `rgba(28, 112, 63, ${opacity})`;
const siemensGreen500 = (opacity: number): string => `rgba(40, 191, 102, ${opacity})`;
const siemensGreen300 = (opacity: number): string => `rgba(114, 230, 163, ${opacity})`;
const siemensBlue700 = 'rgb(30, 82, 153)';
const siemensBlue100 = 'rgb(210, 226, 247)';
  ...
  'layers': [
    {
      ...
      'paint': {
        'background-color': dark ? siemensDeepBlue900 : 'rgb(247, 247, 246)',
    ...
    },
    {
      ...
      'paint': {
        'fill-color': {
          'stops': [
            [8, dark ? siemensGreen500(0.15) : siemensGreen300(0.15)],
            [9, dark ? siemensGreen500(0.15) : siemensGreen300(0.2)],
            [11, dark ? siemensGreen500(0.2) : siemensGreen300(0.3)],
            [13, dark ? siemensGreen500(0.1) : siemensGreen300(0.35)],
            [15, dark ? siemensGreen500(0.15) : siemensGreen300(0.5)]
          ]
        },
        'fill-opacity': 1
      },
    ...
    },
    {
      ...
      'paint': {
        'fill-color': {
          'stops': [
            [8, dark ? siemensGreen700(0.2) : siemensGreen300(0.2)],
            [9, dark ? siemensGreen700(0.25) : siemensGreen300(0.25)],
            [11, dark ? siemensGreen700(0.35) : siemensGreen300(0.35)],
            [13, dark ? siemensGreen700(0.4) : siemensGreen300(0.4)],
            [15, dark ? siemensGreen700(0.6) : siemensGreen300(0.6)]
          ]
        },
        'fill-opacity': 1,
    ...
    },
    {
      ...
      'paint': {
        'line-color': dark ? siemensBlue700 : siemensBlue100,
        'line-width': {
          'stops': [
            [8, 0.5],
            [9, 1],
