...
export class SiMapComponent implements AfterViewInit, OnChanges, OnDestroy, AfterViewChecked {
   ...
   * ```
   */
  readonly moreText = input($localize`:@@SI_MAPS.TOOLTIP_MORE_TEXT:and {{length}} more...`);
  /**
  ...
  protected attributionsLabel = $localize`:@@SI_MAPS.ATTRIBUTIONS_BUTTON:Attributions`;
  protected zoomInLabel = $localize`:@@SI_MAPS.ZOOM_IN_BUTTON:Zoom in`;
  protected zoomOutLabel = $localize`:@@SI_MAPS.ZOOM_OUT_BUTTON:Zoom out`;
  protected zoomToDefaultLabel = $localize`:@@SI_MAPS.ZOOM_TO_DEFAULT_BUTTON:Zoom to default view`;
