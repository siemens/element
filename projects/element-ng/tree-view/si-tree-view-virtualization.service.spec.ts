...
describe('ListVirtualizationService', () => {
  let listVirtualizationService: SiTreeViewVirtualizationService;
  let treeViewService: SiTreeViewService;
  let listItemHeightService: SiTreeViewItemHeightService;
  ...
  beforeEach(async () => {
    ...
    listVirtualizationService = TestBed.inject(SiTreeViewVirtualizationService);
    treeViewService = TestBed.inject(SiTreeViewService);
    listItemHeightService = TestBed.inject(SiTreeViewItemHeightService);
  });

  it('should create ListVirtualizationService', () => {
