...
describe('SiThemeService', () => {
  ...
  describe('without custom theme', () => {
    ...
    beforeEach(() => {
      ...
      store = {
        loadActiveTheme: vi.fn().mockName('store.loadActiveTheme'),
        loadThemeNames: vi.fn().mockName('store.loadThemeNames'),
        saveTheme: vi.fn().mockName('store.saveTheme'),
        activateTheme: vi.fn().mockName('store.activateTheme'),
        deactivateTheme: vi.fn().mockName('store.deactivateTheme'),
        loadTheme: vi.fn().mockName('store.loadTheme'),
        deleteTheme: vi.fn().mockName('store.deleteTheme')
      };
      ...
      store.loadTheme.mockImplementation(() => of(undefined));
