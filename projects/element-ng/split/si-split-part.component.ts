...
export class SiSplitPartComponent {
   ...
   * Passing `undefined` hides the collapse button.
   *
   * @defaultValue 'to-start'
   */
  readonly collapsible = input<CollapseTo | undefined>('to-start');
  ...
  protected readonly showCollapseButton = computed(() => this.collapsible() !== undefined);
