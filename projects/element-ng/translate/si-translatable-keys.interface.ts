...
export interface SiTranslatableKeys {
  ...
  'SI_AI_CHAT_CONTAINER.INPUT_ARGUMENTS'?: string;
  'SI_AI_CHAT_CONTAINER.OUTPUT'?: string;
  'SI_AI_CHAT_CONTAINER.REASONING'?: string;
  ...
  'SI_CHAT_MESSAGE_ACTIONS.SECONDARY_ACTIONS'?: string;
  ...
  'SI_MAP.FIND_MY_LOCATION'?: string;
  'SI_MAP.FULLSCREEN_ENTER'?: string;
  'SI_MAP.FULLSCREEN_EXIT'?: string;
  'SI_MAP.GLOBE_DISABLE'?: string;
  'SI_MAP.GLOBE_ENABLE'?: string;
  'SI_MAP.LOCATION_NOT_AVAILABLE'?: string;
  'SI_MAP.LOGO_TITLE'?: string;
  'SI_MAP.MAC_HELP'?: string;
  'SI_MAP.MAP_FEEDBACK'?: string;
  'SI_MAP.MAP_TITLE'?: string;
  'SI_MAP.MARKER_TITLE'?: string;
  'SI_MAP.MOBILE_HELP'?: string;
  'SI_MAP.POPUP_CLOSE'?: string;
  'SI_MAP.RESET_BEARING'?: string;
  'SI_MAP.SCALE_FEET'?: string;
  'SI_MAP.SCALE_KILOMETERS'?: string;
  'SI_MAP.SCALE_METERS'?: string;
  'SI_MAP.SCALE_MILES'?: string;
  'SI_MAP.SCALE_NAUTICAL_MILES'?: string;
  'SI_MAP.TERRAIN_DISABLE'?: string;
  'SI_MAP.TERRAIN_ENABLE'?: string;
  'SI_MAP.TOGGLE_ATTRIBUTION'?: string;
