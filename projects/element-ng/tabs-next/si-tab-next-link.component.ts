...
import { SiTabNextBaseComponent } from './si-tab-next-base.component';
...
export class SiTabNextLinkComponent extends SiTabNextBaseComponent<SiTabNextLinkComponent> {
  ...
  constructor() {
    super();
    this.routerLinkActive.isActiveChange.pipe(takeUntilDestroyed()).subscribe(isActive => {
      this.active.set(isActive);
    });
  }

  override activateTab(): void {
