...
import { SiFormlyNextComponent } from './si-formly-next.component';

describe('SiFormlyNextComponent', () => {
  ...
  let component: SiFormlyNextComponent<Record<string, any>>;
  let fixture: ComponentFixture<SiFormlyNextComponent<Record<string, any>>>;
  let element: HTMLElement;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, SiFormlyNextComponent],
      providers: [
        provideFormlyCore(),
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(SiFormlyNextComponent<Record<string, any>>, {
      bindings: [
