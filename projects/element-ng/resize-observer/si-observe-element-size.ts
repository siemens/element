...
/**
 * An element or signal resolving to an element observed by {@link observeElementSize}.
 *
 * @experimental
 */
export type ObserveElementSizeSource =
  Element | ElementRef<Element> | Signal<Element | ElementRef<Element> | undefined | null>;
...
export const observeElementSize = (
  source: ObserveElementSizeSource,
