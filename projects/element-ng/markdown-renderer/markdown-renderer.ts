    ...
    return getCachedOrCreateElement(
      ...
      () => {
        ...
        if (options?.copyCodeButton) {
          ...
          copyButton = `<button type="button" class="btn btn-tertiary copy-code-btn" data-code-id="${codeId}" aria-label="${buttonLabel}"><i class="icon element-copy" aria-hidden="true"></i><span class="copy-code-label">${buttonLabel}</span></button>`;
        }
