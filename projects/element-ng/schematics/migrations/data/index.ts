...
import { TYPE_BASED_REPLACEMENTS_MIGRATION } from './type-based-replacement.js';
...
export type ElementMigrationData = {
  ...
  typeBasedReplacementChanges: typeof TYPE_BASED_REPLACEMENTS_MIGRATION;
};
...
export const getElementMigrationData = (): ElementMigrationData => ({
  ...
  typeBasedReplacementChanges: TYPE_BASED_REPLACEMENTS_MIGRATION
});
...
export type { TypeBasedReplacementInstruction } from './type-based-replacement.js';
