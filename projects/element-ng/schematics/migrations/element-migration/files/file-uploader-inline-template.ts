...
@Component({
  ...
  template: `<si-file-uploader uploadTextFileSelect="Select a file" [maxFileSize]="5000000">
      </si-file-uploader>
      <si-file-dropzone [uploadTextFileSelect]="customText" (filesChanged)="onFilesChanged($event)">
      </si-file-dropzone>`
})
