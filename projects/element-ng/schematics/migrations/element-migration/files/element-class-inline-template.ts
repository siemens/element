...
@Component({
  ...
  template: `
    ...
    <button class="btn btn-circle btn-xs"><i class="icon-add"></i></button>

    <!-- btn-circle with btn-sm should have btn-sm removed -->
    <button class="btn btn-circle btn-sm"><i class="icon-edit"></i></button>

    <!-- btn-circle without size should get btn-lg -->
    <button class="btn btn-circle"><i class="icon-delete"></i></button>
    <button class="btn btn-circle btn-primary"><i class="icon-save"></i></button>
    ...
    <button class="btn btn-lg">Large</button>
     ...
     <!-- Anchor buttons -->
  <a href="#" class="btn btn-xs">Link Button XS</a>
  <a href="#" class="btn btn-circle" aria-label="Settings">
