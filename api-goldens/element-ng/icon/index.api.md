...
export class SiIconComponent {
    readonly alt: InputSignal<TranslatableString | undefined>;
    // (undocumented)
...
export class SiIconNextComponent {
    protected readonly fontIcon: Signal<string | undefined>;
    readonly icon: InputSignal<string>;
    // (undocumented)
    protected readonly svgIcon: Signal<SafeHtml | undefined>;
    // (undocumented)
...
export class SiStatusIconComponent {
    // (undocumented)
    readonly status: InputSignal<EntityStatusType>;
    // (undocumented)
