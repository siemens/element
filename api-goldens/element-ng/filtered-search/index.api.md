...
export class SiFilteredSearchComponent implements OnInit, OnChanges {
    ...
    readonly createFreeTextPillLabel: _angular_core.InputSignal<TranslatableString>;
    ...
    readonly disableFreeTextPills: _angular_core.InputSignalWithTransform<boolean, unknown>;
