...
- Tailor the tone to be professional yet approachable, with a focus on helping users finding the information they're looking for.
...
- Proper nouns (e.g., names, places, brands) and acronyms (e.g., FAQ, API) must always be capitalized.
